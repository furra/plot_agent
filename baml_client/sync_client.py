...
class BamlSyncClient:
    ...
    def GenerateSQLQuery(self, user_query: str,schema: str,engine: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateSQLQuery", args={
...
class BamlStreamClient:
    ...
    def GenerateSQLQuery(self, user_query: str,schema: str,engine: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateSQLQuery", args={
            "user_query": user_query,"schema": schema,"engine": engine,
        })
...
class BamlHttpRequestClient:
    ...
    def GenerateSQLQuery(self, user_query: str,schema: str,engine: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateSQLQuery", args={
            "user_query": user_query,"schema": schema,"engine": engine,
        }, mode="request")
        return result
